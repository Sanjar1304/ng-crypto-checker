...
export class CoinDetailComponent implements OnInit {
  ...
  getCoinData(){
    this.api.getCurrencyById(this.coinId).subscribe(res => {
      ...
      res.market_data.current_price.rub = res.market_data.current_price.rub;
      res.market_data.market_cap.rub = res.market_data.market_cap.rub;
      this.coinData = res;
    })
  }
  ...
  getGraphData(days: number){
    this.days = days
    this.api.getGraphicalData(this.coinId, this.currency, this.days).subscribe(res => {
      setTimeout(() => {
